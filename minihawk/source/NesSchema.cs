		...
		private static PadSchema FamicomFamilyKeyboard(int controller)
		{
			return new PadSchema
			{
				...
				Buttons = new[]
				{
					...
					new ButtonSchema(320, 38, controller, "Yen", "Â¥"),
					...
					new ButtonSchema(352, 84, controller, "ã‚«ãƒŠ"),
					...
					new ButtonSchema(468, 86, controller, "Up", "  â†‘  "),
					new ButtonSchema(468, 134, controller, "Down", "  â†“  "),
					new ButtonSchema(446, 110, controller, "Left", "  â†  "),
					new ButtonSchema(488, 110, controller, "Right", "  âž  ")
				}
			};
		}
	}
